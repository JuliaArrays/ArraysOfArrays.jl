...
# without custom rules. Only the functions that query shape/structure
# information, and are therefore not differentiable with respect to array
# contents, get explicit zero-derivative rules:
